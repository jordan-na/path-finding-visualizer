...
import classes from "./PointIcon.module.css";
...
const PointIcon = (props) => {
   ...
   return (
      <svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 166.418 166.418" className={`${props.className} ${classes[themeContext.theme]}`}>
         <path strokeWidth="8"
               stroke="#D3D3D3"

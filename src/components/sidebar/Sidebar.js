...
const pointControls = ["Wall", "Pitstop", "Weight"];

const clearControls = ["Clear Board", "Clear Walls", "Clear Pitstops", "Clear Weights", "Clear Visited", "Clear Path"];
      ...
      <div className={`${classes.sidebar} ${open ? classes.open : ""} ${classes[themeContext.theme]}`}>
         ...
         <nav className={classes.controls}>
            ...
            <SidebarControl
               ...
               onControlChange={gridContext.clearNodes}
               sidebarOpened={open}
            />
            <SidebarControl
               control="Speed"
